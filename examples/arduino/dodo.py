...
ARDUINO_DIR = os.path.join('programs_win', 'arduino-1.0.5')

C_COMPILER = os.path.join(ARDUINO_DIR, 'hardware', 'tools', 'avr', 'bin', 'avr-gcc')

C_INCLUDE_FLAGS = [
    '-I' + os.path.join(ARDUINO_DIR, 'hardware', 'arduino', 'cores', 'arduino'),
    '-I' + os.path.join(ARDUINO_DIR, 'hardware', 'arduino', 'variants', 'standard'),
]
...
C_COMPILER = os.path.join(ARDUINO_DIR, 'hardware', 'tools', 'avr', 'bin', 'avr-g++')

CPP_INCLUDE_FLAGS = C_INCLUDE_FLAGS

CPP_FLAGS = C_FLAGS + ['-fno-exceptions']

LINKER = os.path.join(ARDUINO_DIR, 'hardware', 'tools', 'avr', 'bin', 'avr-gcc')
...
LINKER = os.path.join(ARDUINO_DIR, 'hardware', 'tools', 'avr', 'bin', 'avr-objcopy')
...
AVRDUDE_PATH = os.path.join(ARDUINO_DIR, 'hardware', 'tools', 'avr', 'bin', 'avrdude')

AVRDUDE_CONF_FILE = os.path.join(ARDUINO_DIR, 'hardware', 'tools', 'avr', 'etc' 'avrdude.conf')
...
def get_avrdude_command_str(hex_file):
    return ' '.join([AVRDUDE_PATH] + AVRDUDE_FLAGS +
                    ['-Uflash:w:' + hex_file + ':i'])
